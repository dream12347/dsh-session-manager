...
`;
		...
		*/
		...
		function SessionDrawer({ api, sessions }) {
			...
			const strings = stringsOf();
			const list = (0, react.useSyncExternalStore)((0, react.useCallback)((fn) => sessions.list.subscribe(fn), [sessions]), (0, react.useCallback)(() => sessions.list.getSnapshot(), [sessions]));
