...
`;
		...
		function stringsOf() {
			return isZh() ? {
				title: "会话管理",
				count: (used, total) => `${used} / ${total} 个会话`,
				current: "当前会话",
				delete: "删除",
				deleting: "删除中…",
				...
				count: (used, total) => `${used} / ${total} sessions`,
